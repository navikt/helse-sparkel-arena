...
internal class Dagpenger(rapidsConnection: RapidsConnection, private val ytelseskontraktV3: YtelseskontraktV3) :
    River.PacketListener {
    private companion object {
        private val sikkerlogg = LoggerFactory.getLogger("tjenestekall")
        private val log = LoggerFactory.getLogger(Dagpenger::class.java)

        private const val behov = "Dagpenger"
    }
